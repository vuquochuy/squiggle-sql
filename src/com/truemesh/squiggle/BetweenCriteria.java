...
public class BetweenCriteria extends Criteria {
	...
	/**
	 * Initializes a new BetweenCriteria with a BigDecimal column and a
	 * BigDecimal range which serves as the bounds for the SQL BETWEEN operator
	 * within which the operator tests whether the column lies.
	 * 
	 * @param column
	 ...
	 * 
	 * @param range
	 *            the BigDecimal bounds for the SQL BETWEEN operator within
	 *            which the operator tests whether the column lies.
	 */
	public BetweenCriteria(Matchable column, BigDecimalRange range) {
		this.column = column;
		this.range = new StringRange(range.getStart().toString(), range
				.getEnd().toString());
	}

	/**
	 * Initializes a new BetweenCriteria with a Date column and a Date range
	 ...
	 *            the first operand to the SQL BETWEEN operator that the
	 *            operator uses to test whether the column falls within the
	 *            given range. The SQL type of the column must be TIMESTAMP.
	 * 
	 * @param range
	 *            the Date bounds for the SQL BETWEEN operator within which the
	 *            operator tests whether the column lies.
	 */
	public BetweenCriteria(Matchable column, DateRange range) {
		this.column = column;
		DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.S");
		this.range = new StringRange("'" + dateFormat.format(range.getStart())
	 ...
	 *            the first operand to the SQL BETWEEN operator that the
	 *            operator uses to test whether the column falls within the
	 *            given range. The SQL type of the column must be DOUBLE.
	 * 
	 * @param range
	 *            the Double bounds for the SQL BETWEEN operator within which
	 *            the operator tests whether the column lies.
	 */
	public BetweenCriteria(Matchable column, DoubleRange range) {
		this.column = column;
		this.range = new StringRange(range.getStart().toString(), range
				.getEnd().toString());
	}
	 ...
	 *            the first operand to the SQL BETWEEN operator that the
	 *            operator uses to test whether the column falls within the
	 *            given range. The SQL type of the column must be FLOAT.
	 * 
	 * @param range
	 *            the Float bounds for the SQL BETWEEN operator within which the
	 *            operator tests whether the column lies.
	 */
	public BetweenCriteria(Matchable column, FloatRange range) {
		this.column = column;
		this.range = new StringRange(range.getStart().toString(), range
				.getEnd().toString());
	}
	...
	/**
	 * Initializes a new BetweenCriteria with a Integer column and a Integer
	 * range which serves as the bounds for the SQL BETWEEN operator within
	 * which the operator tests whether the column lies.
	 * 
	 * @param column
	 *            the first operand to the SQL BETWEEN operator that the
	 *            operator uses to test whether the column falls within the
	 *            given range. The SQL type of the column must be INTEGER.
	 * 
	 * @param range
	 *            the Integer bounds for the SQL BETWEEN operator within which
	 *            the operator tests whether the column lies.
	 */
	public BetweenCriteria(Matchable column, IntegerRange range) {
		this.column = column;
		this.range = new StringRange(range.getStart().toString(), range
				.getEnd().toString());
	}
	...
	public void write(Output out) {
		out.print(column).print(" BETWEEN ").print(range.getStart()).print(
				" AND ").print(range.getEnd());
	}
